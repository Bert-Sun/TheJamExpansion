    ...
    def check(self, bullets, pickups):  
        ...
        if self.health <= 0:
            ...
            if self.health_drop_chance <= .15:
                pickups.append(items.Heart(self.x, self.y, 200))
...
class Boss():
    ...
    def check(self):
        ...
        if 0 <= self.health%500 <= 10 and self.health != self.max_health:
            pickups.append(items.Heart(random.randint(300, 700), random.randint(200, 500), random.randint(250, 500)))        
